...
class Index extends Component
{
    ...
    public function editDeptByBU($idBu,$idDept)
    {
        
        $ids = DeptByBU::where('department_id', $idDept)->where('busines_unit_id', $idBu)->first()->id;
       
        $this->dispatch('deptByBU_updated', $ids);
    }
    public function deleteSubConDept($idBu,$idDept)
    {
