...
class Index extends Component
{
    ...
    public function editSubConDept($idDept,$idCompany)
    {
        
        $ids = SubConDept::where('department_id', $idDept)->where('company_id', $idCompany)->first()->id;
       
        $this->dispatch('subConDept_updated', $ids);
    }
    public function deleteSubConDept($idDept,$idCompany)
    {
