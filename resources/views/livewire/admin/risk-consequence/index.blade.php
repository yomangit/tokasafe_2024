<div>
    ...
    <div class="flex flex-col sm:flex-row sm:justify-between ">
        <div> @livewire('admin.risk-consequence.create-and-update') </div>
        <div>
            ...
            <tbody>
                ...
                @forelse ($Risk_con as $no => $risk)
                    <tr >
                        ...
                        <td class="text-left p-0 text-xs font-semibold">{{ $risk->risk_consequence_name }}</td>
                        <td class="text-justify w-full px-4">{{ $risk->description }}</td>
                        <td>
